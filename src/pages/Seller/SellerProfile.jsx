...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaEdit, FaSave, FaTimes, FaCamera, FaStore, FaLock } from 'react-icons/fa';
...
export default function SellerProfile() {
    ...
    const [profileData, setProfileData] = useState({
        name: "John Doe",
        email: "seller@nextrade.com",
        phone: "+1 234 567 8900",
        storeName: "Nextrade Store",
        address: "123 Business Street, City, State 12345",
        bio: "Professional seller with 5+ years of experience in e-commerce. Specialized in electronics and home appliances.",
        ...
        <div className="min-h-screen bg-background-light">
            <div className="max-w-6xl p-6 mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-neutral-600">Manage your account information and store details</p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky p-6 bg-white rounded-lg shadow-lg top-6">
                            ...
                            <div className="flex flex-col items-center mb-6">
                                ...
                                <p className="mt-1 text-sm text-neutral-600">Seller</p>
                            </div>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="p-6 mb-4 bg-white rounded-lg shadow-lg">
                            <h3 className="mb-6 text-xl font-bold text-neutral-800">Personal Information</h3>
                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        ...
                                        <div className="p-3 rounded-lg bg-background-subtle">
                                            <p className="leading-relaxed text-neutral-800">{profileData.bio}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="p-6 text-center bg-white rounded-lg shadow-lg">
                                ...
                                <div className="mt-1 text-sm text-neutral-600">Total Products</div>
                            </div>
                            <div className="p-6 text-center bg-white rounded-lg shadow-lg">
                                <div className="text-2xl font-bold text-primary-600">892</div>
                                <div className="mt-1 text-sm text-neutral-600">Orders Completed</div>
                            </div>
                        </div>
                    </div>
                </div>
